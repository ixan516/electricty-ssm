...
<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath }/WEB-INF/jsp/workflow/flowMyTaskList.jsp" method="post" style="margin:0px;">
								...
								<td width="12%" align="center" height=22 background="${pageContext.request.contextPath }/images/tablehead.jpg">查看流程记录</td>
									...
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td style="HEIGHT:22px" align="center" width="10%">
											<a id="Form2_" href="${pageContext.request.contextPath }/WEB-INF/jsp/workflow/flowApprove.jsp?applicationID=2&taskID=60006"><img src="${pageContext.request.contextPath }/images/handle.gif" width="16" height="16" border="0" style="CURSOR:hand"></a>
										</td>
										<td style="HEIGHT:22px" align="center" width="12%">
											<a id="Form2_" href="${pageContext.request.contextPath }/WEB-INF/jsp/workflow/flowApprovedHistory.jsp?applicationID=2"><img src="${pageContext.request.contextPath }/images/button_view.gif" border="0" style="CURSOR:hand"></a>
										</td>
									</tr>
						</table>		
					</td>
