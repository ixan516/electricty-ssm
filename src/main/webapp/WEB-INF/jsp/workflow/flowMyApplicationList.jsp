...
<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath }/WEB-INF/jsp/workflow/flowMyApplicationList.jsp" method="post" style="margin:0px;">
								...
								<td width="12%" align="center" height=22 background="${pageContext.request.contextPath }/images/tablehead.jpg">查看流程记录</td>
									...
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										<td style="HEIGHT:22px" align="center" width="30%">
											设备购置计划模板_张三_2012-02-27 00:18:25
										</td>
										<td style="HEIGHT:22px" align="center" width="25%">
											张三
										</td>
										<td style="HEIGHT:22px" align="center" width="23%">
											2012-02-27 00:18:25.0
										</td>
										<td style="HEIGHT:22px" align="center" width="10%">
											审核中
										</td>
										<td style="HEIGHT:22px" align="center" width="12%">
											<a id="Form2_" href="${pageContext.request.contextPath }/WEB-INF/jsp/workflow/flowApprovedHistory.jsp?applicationID=3"><img src="${pageContext.request.contextPath }/images/button_view.gif" border="0" style="CURSOR:hand"></a>
										</td>
									</tr>
						</table>		
					</td>
