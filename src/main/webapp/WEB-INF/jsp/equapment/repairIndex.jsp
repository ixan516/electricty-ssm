    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('#grid').datagrid( {
                ...
                pagination : true,
                toolbar : toolbar,
                url : "${pageContext.request.contextPath }/equapment/findAllRepairRecords.action",
                columns : columns,
        ...
        function doEdit(){
            ...
            if(rows.length != 1){
                ...
                $.ajax({
                    type: "get",
                    dataType: "json",
                    url: "${pageContext.request.contextPath}/equapment/getRepairRecordById.action",
                    data: "id="+rows[0].id,
                ...
                $.messager.confirm('确认信息','您确定删除选中数据么?',function(r){
                    if(r){
                        ...
                        $.ajax({
                            type: "get",
                            dataType: "json",
                            url: "${pageContext.request.contextPath}/equapment/deleteRepairRecord.action",
                            data: "ids="+ids,
                            success: function (result) {
                                // 清除所有选择的行
                        ...
                        $('#save').click(function () {
                            ...
                            if (b) {
                                ...
                                $.ajax({
                                    ...
                                    url: "${pageContext.request.contextPath}/equapment/addRepairInfo.action",
        ...
        <div region="center" style="overflow:auto;padding:5px;" border="false">
            <form id="addUserForm">
                <table class="table-edit" width="80%" align="center">
                    <tr class="title">
                        <td colspan="4">设备校准信息</td>
                    </tr>
                    <tr>
                        <td>设备名称</td>
                        <td>
                            <input type="text" name="devId" class="easyui-combobox"
                                   data-options="required:true,valueField:'id',textField:'name',
											url:'${pageContext.request.contextPath}/equapment/findDevices.action'"/>
                        </td>
                        <td>所属单位</td>
                        <td>
                    ...
                    <tr>
                        <td>设备状态</td>
                        <td>
                            <input type="text" name="isHaving" class="easyui-combobox"
                                   data-options="required:true,valueField:'id',textField:'name',
											url:'${pageContext.request.contextPath}/dict/findDictByDeviceStatus.action'"/>
                        </td>
                        <td>校准日期</td>
                        <td>
                            <input type="text" name="startDate" class="easyui-datebox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td>校准记录</td>
                        <td>
                            <input type="text" name="record" class="easyui-validatebox" required="true"/>
                        </td>
                        <td>备注</td>
                        <td>
