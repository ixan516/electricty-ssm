    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('#grid').datagrid( {
                ...
                pagination : true,
                toolbar : toolbar,
                url : "${pageContext.request.contextPath }/station/getAllSiteInfo.action",
                columns : columns,
        ...
        function doEdit(){
            ...
            if(rows.length != 1){
                ...
                $.ajax({
                    type: "get",
                    dataType: "json",
                    url: "${pageContext.request.contextPath}/station/getSiteInfoById.action",
                    data: "id="+rows[0].id,
                ...
                $.messager.confirm('确认信息','您确定删除选中数据么?',function(r){
                    if(r){
                        ...
                        $.ajax({
                            type: "get",
                            dataType: "json",
                            url: "${pageContext.request.contextPath}/station/deleteStationInfo.action",
                            data: "ids="+ids,
                            success: function (result) {
                                // 清除所有选择的行
...
<div region="center" border="false">
    <table id="grid"></table>
    <div class="easyui-window" title="对站点信息添加或者修改" id="addWindow" collapsible="false" minimizable="false" maximizable="false"
                        ...
                        $('#save').click(function () {
                            ...
                            if (b) {
                                ...
                                $.ajax({
                                    ...
                                    url: "${pageContext.request.contextPath}/station/addSiteInfo.action",
            ...
            <form id="addUserForm">
                <table class="table-edit" width="80%" align="center">
                    ...
                    <tr>
                        ...
                        <td>站点名称</td>
                        <td>
                            <input type="text" name="stationName" class="easyui-validatebox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td>站点代号</td>
                        <td>
                            <input type="text" name="stationCode" class="easyui-validatebox" required="true" />
                        </td>
                        <td>使用时间</td>
                        <td>
                            <input type="text" name="useStartDate" class="easyui-datebox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td>安装地点</td>
                        <td>
                            <input type="text" name="installAddress" class="easyui-validatebox" required="true"/>
                        </td>
                        <td>生产厂家</td>
                        <td>
                    ...
                    <tr>
                        <td>联系方式</td>
                        <td>
                            <input type="text" name="contactType" class="easyui-validatebox" required="true"/>
                        </td>
                        <td>站点类别</td>
                        <td>
                            <input type="text" name="stationType" class="easyui-combobox"
                                   data-options="required:true,valueField:'id',textField:'name',
											url:'${pageContext.request.contextPath}/dict/findDictBySiteType.action'"/>
                        </td>
                    </tr>
                    <tr>
                        <td>归属地</td>
                        <td>
                            <input type="text" name="attributeGround" class="easyui-validatebox" required="true"/>
                        </td>
                        <td>备注</td>
                        <td>
    ...
    <!-- 查询站点基本信息窗口-->
    <div class="easyui-window" title="查询站点基本信息窗口" closed="true" id="searchWindow" collapsible="false" minimizable="false"
            ...
            <form id="searchForm">
                <table class="table-edit" width="80%" align="center">
                    ...
                    <tr>
                        <td>归属地</td>
                        <td>
                            <input type="text" name="attributeGround"/>
                        </td>
                    </tr>
                    <tr>
                                ...
                                $(function () {
                                    ...
                                    $('#searchBtn').click(function () {
                                        ...
                                        $.ajax({
                                            ...
                                            dataType: "json",
                                            contentType: "application/json;charset=utf-8",
                                            url: "${pageContext.request.contextPath}/station/querySiteInfoByExample.action",
                                            data: JSON.stringify(data),
                                            success: function (result) {
