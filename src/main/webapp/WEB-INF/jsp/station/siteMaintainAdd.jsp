...
<Script language="javascript">
	function check_null() {
		...
		document.Form1.action = "station/elecPlanAction_save.do";
	...
	function upload() {
		...
		var str = "${pageContext.request.contextPath }/station/elecFileUploadAction_up.do";
		...
		<table cellspacing="1" cellpadding="5" width="680" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff"><input name="occurDate"
					type="text" maxlength="40" id="occurDate" onclick="WdatePicker()">
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><textarea
						...
						style="WIDTH: 86%; height: 130"></textarea> &nbsp;&nbsp;<span
					id=PResolve style="DISPLAY: ''"><input id="btnContent"
						type="button" value=" 详细" name="btnContent" onclick="upload();"
						style="font-size: 12px; color: black;"></span></td>
			</tr>
			<tr>
				<td class="ta_01" align="center" bgcolor="#f5fafe">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><textarea
						name="comment" id="comment" style="WIDTH: 96%; height: 130"></textarea></td>
			</tr>
			<tr>
