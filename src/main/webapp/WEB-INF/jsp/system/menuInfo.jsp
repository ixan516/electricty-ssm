    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('#grid').datagrid( {
                ...
                pagination : true,
                toolbar : toolbar,
                url : "${pageContext.request.contextPath }/menu/getMenus.action",
                columns : columns,
                        ...
                        $('#save').click(function(){
                            ...
                            if(b){
                                ...
                                $.ajax({
                                    ...
                                    url: "${pageContext.request.contextPath}/menu/addMenuTree.action",
            ...
            <form id="addUserForm" >
                <table class="table-edit" width="80%" align="center">
                    ...
                    <tr>
                        <td>所属层级</td>
                        <td>
                            <input type="text" name="pId" class="easyui-textbox" />
                        </td>
                    </tr>
                    <tr>
                        <td>路径</td>
                        <td>
                            <input type="text" name="page" class="easyui-validatebox" required="true" />
                        </td>
                    </tr>
                </table>
            </form>
